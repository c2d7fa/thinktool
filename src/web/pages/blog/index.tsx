    ...
    <StaticPage>
      ...
      <main>
        <div className="block small centered">
          ...
          <ul className="posts">
            <li>
              <a href="newsletter-october-2020.html" className="post newsletter-post">
                <h1>Newsletter</h1>
            ...
            <li>
              <a href="newsletter-july-2020.html" className="post newsletter-post">
                <h1>Newsletter</h1>
            ...
            <li>
              <a href="zettelkasten-principles.html" className="post">
                <time dateTime="2020-06-08">June 8th, 2020</time>
                <h1>Taking better notes with principles from the Zettelkasten method.</h1>
                <p>
                  Three rules &ndash; inspired by Niklas Luhmann's Zettelkasten &ndash; that you can apply to
                  take better notes.
                </p>
              </a>
            </li>
            <li>
              <a href="/tutorial.html" className="post">
                ...
                <p>
                  Tutorial that shows you how to get started with Thinktool, and gives some tips about
                  note-taking in the process.
                </p>
              </a>
            </li>
            <li>
              <a href="newsletter-may-2020.html" className="post newsletter-post">
                <h1>Newsletter</h1>
