...
export const initialState: D.State = (() => {
  ...
  add(
    "1",
    "2",
    "If you like this demo, you can sign up for an account here: https://thinktool.io/login.html",
  );
  ...
  add(
    "5",
    "6",
    "(You can also use Ctrl+Enter anywhere to create a new item. If you want to insert a newline, use Shift+Enter.)",
  );
  ...
  add(
    "4",
    "8",
    "One of the unique features of Thinktool is the ability to have the same item in multiple places:",
  );
  add(
    "8",
    "9",
    "To copy an item to a different location, move an item, but hold down Ctrl while dropping it. This will create a copy of the same item.",
  );
  ...
  add(
    "8",
    "13",
    "You can also press Alt+C while having an item to selected to insert an existing item as a child of the selected item. Enter some text to search for an item.",
  );
  add(
    "8",
    "14",
    "When an item has multiple parents, its other parents are automatically shown when you unfold it.",
  );
  ...
  add(
    "19",
    "20",
    "This will show the item in full screen, and you can easily navigate to all of its parents, children and references.",
  );
